...
const Sidebar: React.FC = () => {
  ...
  <div className="flex flex-col space-y-4 flex-grow">
    ...
    <button
      className="py-3 px-5 text-left text-gray-800 font-medium rounded-lg transition-colors duration-300 border-l-4 border-transparent hover:bg-gray-200 hover:border-l-red-500"
      onClick={() => logout()}
    >
      Logout
    </button>
